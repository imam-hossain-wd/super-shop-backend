...
const getAllProducts = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filters = (0, pick_1.default)(req.query, product_constrants_1.productFilterableFields);
    // console.log(filters, 'product filters..');
    const result = yield product_service_1.productService.getAllProducts(options, filters);
